                    ...
                    {filteredAppointments.map((appointment) => (
                      <tr key={appointment._id} className="table-row">
                        <td className="px-4 py-4">
                          <div>
                            <div className="font-medium text-gray-800">{appointment.patient.name}</div>
                            <div className="text-gray-600 text-sm">{appointment.patient.email}</div>
                            <div className="text-gray-500 text-xs">{appointment.patient.phone}</div>
                          </div>
                        </td>
                        <td className="px-4 py-4">
                          <div className="font-medium text-gray-800">{appointment.doctor.name}</div>
                          <div className="text-gray-600 text-sm">{appointment.doctor.department}</div>
                          <div className="text-gray-500 text-xs">{appointment.doctor.specialty}</div>
                        </td>
                        <td className="px-4 py-4">
